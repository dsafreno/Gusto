...
class PinsControllerTest < ActionController::TestCase
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post :create, pin: { latitude: @pin.latitude, longitude: @pin.longitude, user_id: @pin.user_id }
    end
  ...
  test "should update pin" do
    put :update, id: @pin, pin: { latitude: @pin.latitude, longitude: @pin.longitude, user_id: @pin.user_id }
    assert_redirected_to pin_path(assigns(:pin))
  end
